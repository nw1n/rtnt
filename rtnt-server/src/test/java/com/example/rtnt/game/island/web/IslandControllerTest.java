...
class IslandControllerTest {
    ...
    void getAllReturnsNameGeographyAndPopulation() throws Exception {
        ...
        this.mockMvc.perform(get("/api/islands"))
                ...
                .andExpect(jsonPath("$[0].tradePrices.rum").value(18))
                .andExpect(jsonPath("$[0].tradePrices.sugar").value(18))
                .andExpect(jsonPath("$[0].tradePrices.spices").value(18))
                .andExpect(jsonPath("$[0].tradePrices.tobacco").value(18));
    }
